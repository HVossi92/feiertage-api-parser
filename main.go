...
func run() error {
	...
	for year := cliConfig.startYear; year <= cliConfig.endYear; year++ {
		url := fmt.Sprint("https://feiertage-api.de/api/?jahr=", year)
		...
		if resp.StatusCode == http.StatusOK {
			parseJsonBody(resp.Body, &holidays)
		}
	}
...
func parseJsonBody(body io.ReadCloser, holidays *[]Holiday) error {
